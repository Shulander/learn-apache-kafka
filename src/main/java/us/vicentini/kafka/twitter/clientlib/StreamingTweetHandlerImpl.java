...
package us.vicentini.kafka.twitter.clientlib;
...
public class StreamingTweetHandlerImpl extends StreamingTweetHandler {
    ...
    public StreamingTweetHandlerImpl(TwitterApi apiInstance, Consumer<Tweet> consumer) {
        super(apiInstance);
        this.consumer = consumer == null ? new Consumer<Tweet>() {
            @Override
            public void accept(Tweet tweet) {
                log.info("New streaming tweet: {}", tweet.getText());
            }
        } : consumer;
    }
    ...
    public void actionOnStreamingObject(StreamingTweetResponse streamingTweet) throws ApiException {
        ...
        if (streamingTweet.getErrors() != null) {
            ...
            consumer.accept(streamingTweet.getData());
        }
    }
}
